<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FieldEventEntry.aspx.cs" Inherits="FieldEventEntry" %>
...
<body id="PageBody" runat="server">
    ...
    <div>
        ...
        <br />
        <asp:Button Class="Button" ID="cmdClear" runat="server" Text="Clear Flight" OnClick="cmdClear_Click" />
        &nbsp;
        ...
        <asp:Panel ID="panClear" CSSClass="Panel" runat="server" BorderColor="#CC0000" Visible="False">
            <br />
            Are you sure you want to clear all data from this flight?
        ...
        <asp:Button Class="Button" ID="cmdPrevious" runat="server" Text="Previous Flight" OnClick="cmdPrevious_Click" />
        &nbsp;
        <asp:Button Class="Button" ID="cmdNext" runat="server" Text="Next Flight" OnClick="cmdNext_Click" />
        <br />
        &nbsp;
        <br />
        <asp:Label ID="lblFlightNum" runat="server" Text="Flight #1"></asp:Label>
        <br />
        &nbsp;
        <asp:Panel ID="Panel1" CSSClass="Panel" runat="server">
            <table>
                ...
                <tr>
                    <td>1</td>
                    <td>
                        <asp:TextBox ID="txtName1" runat="server" AutoPostBack="True"></asp:TextBox>
                    </td>
                    <td>
